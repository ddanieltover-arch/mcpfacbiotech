...
export function InvoicesPageClient() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-heading text-3xl font-bold text-brand-deep">My Invoices</h1>
        <p className="mt-2 text-neutral-600">Invoices issued when orders are confirmed.</p>
      </div>
