...
export function OrdersPageClient() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-heading text-3xl font-bold text-brand-deep">My Orders</h1>
        <p className="mt-2 text-neutral-600">Track research orders placed from cart or quotes.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-dashed border-neutral-300 bg-white p-12 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-500">
            Checkout from your cart or convert a submitted quote.
          </p>
          <Link
            href="/cart"
