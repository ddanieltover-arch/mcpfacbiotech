...
BATCH_8_ITEMS = [
    {"slug": "ss-31", "name": "SS-31", "dose": "10mg (Elamipretide)", "type": "Mitochondrial Peptide"},
    {"slug": "lipo-b", "name": "LIPO-B", "dose": "10mL Multidose", "type": "Lipotropic Injection"},
    {"slug": "aicar", "name": "AICAR", "dose": "50mg", "type": "Lyophilized Powder"},
    {"slug": "fat-blaster-lc526", "name": "Fat Blaster LC526", "dose": "10mL Solution", "type": "Metabolic Complex"},
    {"slug": "snap-8-10mg", "name": "SNAP-8", "dose": "10mg", "type": "Cosmetic Peptide"},
    {"slug": "bac-water", "name": "BAC Water", "dose": "30mL Sterile Solution", "type": "Bacteriostatic Water"},
    {"slug": "tb-500-10mg", "name": "TB-500", "dose": "10mg", "type": "Lyophilized Powder"},
    {"slug": "bpc-157-tb-500-5mg-5mg", "name": "BPC-157 + TB-500", "dose": "5mg / 5mg Blend", "type": "Dual Peptide Matrix"},
    {"slug": "dsip-10mg", "name": "DSIP", "dose": "10mg", "type": "Lyophilized Powder"},
    {"slug": "epitalon-50mg", "name": "Epitalon", "dose": "50mg", "type": "Lyophilized Powder"},
]

BATCH_8_MAPPING = {}

def render_photorealistic_batch_8():
    ...
    for item in BATCH_8_ITEMS:
        ...
        BATCH_8_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 8 photorealistic images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_8_MAPPING.items():
