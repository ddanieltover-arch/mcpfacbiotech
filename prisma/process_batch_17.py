...
BATCH_17_ITEMS = [
    {"slug": "cjc-1295-dac-ipamorelin-10mg", "name": "CJC-1295 / Ipamorelin", "dose": "10mg Blend", "type": "Secretagogue Complex"},
    {"slug": "hgh-191aa-100iu", "name": "Somatropin HGH", "dose": "100IU Research Kit", "type": "Human Growth Hormone"},
    {"slug": "mgf-5mg", "name": "MGF", "dose": "5mg High Dose", "type": "Mechano Growth Factor"},
    {"slug": "peg-mgf-10mg", "name": "PEG-MGF", "dose": "10mg High Dose", "type": "Pegylated Growth Factor"},
    {"slug": "n-acetyl-semx-amidate-10mg", "name": "NA-Semax Amidate", "dose": "10mg", "type": "Acetylated Nootropic"},
    {"slug": "n-acetyl-selank-amidate-10mg", "name": "NA-Selank Amidate", "dose": "10mg", "type": "Acetylated Anxiolytic"},
    {"slug": "glow-blend-20mg", "name": "GLOW Blend", "dose": "20mg Ultra Dose", "type": "Rejuvenation Complex"},
    {"slug": "recovery-stack-ultra", "name": "Recovery Stack", "dose": "Ultra Formulation", "type": "Multidimensional Healing"},
    {"slug": "skinny-shot-blend-pro", "name": "Skinny Shot Blend", "dose": "Pro Formulation", "type": "Metabolic Optimization"},
    {"slug": "super-shred-blend-max", "name": "Super Shred Blend", "dose": "Max Strength", "type": "Thermogenic Complex"},
]

BATCH_17_MAPPING = {}

def render_photorealistic_batch_17():
    ...
    for item in BATCH_17_ITEMS:
        ...
        BATCH_17_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 17 photorealistic images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_17_MAPPING.items():
    ...
    print("\nBatch 17 Complete Summary:")
    for slug, url in results.items():
        print(f"  {slug}: {url}")

def main():
    render_photorealistic_batch_17()
    upload_and_sync_all()
