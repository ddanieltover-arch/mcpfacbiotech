...
BATCH_21_ITEMS = [
    {"slug": "bpc-157-arginate-salt-20mg", "name": "BPC Arginate Salt", "dose": "20mg Ultra Stable", "type": "Gastric Peptide"},
    {"slug": "aod-9604-15mg", "name": "AOD-9604 Lipolytic", "dose": "15mg High Dose", "type": "Metabolic Fragment"},
    {"slug": "ll-37-30mg", "name": "LL-37 Antimicrobial", "dose": "30mg High Dose", "type": "Host Defense Peptide"},
    {"slug": "mots-c-30mg", "name": "MOTS-c Mitochondrial", "dose": "30mg High Dose", "type": "AMPK Activator"},
    {"slug": "oxytocin-30mg", "name": "Oxytocin Neuropeptide", "dose": "30mg High Dose", "type": "Hypothalamic Hormone"},
    {"slug": "pinealon-50mg", "name": "Pinealon Bioregulator", "dose": "50mg High Dose", "type": "Brain Tripeptide"},
    {"slug": "vesugen-50mg", "name": "Vesugen Bioregulator", "dose": "50mg High Dose", "type": "Vascular Peptide"},
    {"slug": "thymosin-a1-30mg", "name": "Thymosin-α1 Immune", "dose": "30mg High Dose", "type": "Thymic Peptide"},
    {"slug": "epithalon-50mg-vial", "name": "Epithalon Telomerase", "dose": "50mg High Dose", "type": "Pineal Peptide"},
    {"slug": "bpc-157-tb-500-30mg", "name": "BPC / TB Ultra Blend", "dose": "30mg Ultra Blend", "type": "Tissue Repair Stack"},
]

BATCH_21_MAPPING = {}

def render_photorealistic_batch_21():
    ...
    for item in BATCH_21_ITEMS:
        ...
        BATCH_21_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 21 photorealistic images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_21_MAPPING.items():
    ...
    print("\nBatch 21 Complete Summary:")
    for slug, url in results.items():
        print(f"  {slug}: {url}")

def main():
    render_photorealistic_batch_21()
    upload_and_sync_all()
