...
BATCH_14_ITEMS = [
    {"slug": "igf-1-des-1mg", "name": "IGF-1 DES", "dose": "1mg", "type": "Truncated Growth Factor"},
    {"slug": "peg-mgf-2mg", "name": "PEG-MGF", "dose": "2mg Standard", "type": "Pegylated Mechano Growth"},
    {"slug": "cjc-1295-2mg", "name": "CJC-1295", "dose": "2mg", "type": "Growth Hormone Secretagogue"},
    {"slug": "hexarelin-2mg", "name": "Hexarelin", "dose": "2mg", "type": "Potent Ghrelin Agonist"},
    {"slug": "ghrp-2-5mg", "name": "GHRP-2", "dose": "5mg", "type": "Growth Secretagogue"},
    {"slug": "ghrp-6-5mg", "name": "GHRP-6", "dose": "5mg", "type": "Growth Peptide Analog"},
    {"slug": "ipamorelin-2mg", "name": "Ipamorelin", "dose": "2mg", "type": "Selective Ghrelin Mimetic"},
    {"slug": "sermorelin-2mg", "name": "Sermorelin", "dose": "2mg", "type": "GHRH (1-29) Fragment"},
    {"slug": "mots-c-5mg", "name": "MOTS-c", "dose": "5mg", "type": "Mitochondrial Peptide"},
    {"slug": "aod-9604-2mg", "name": "AOD-9604", "dose": "2mg", "type": "Metabolic Lipolytic Fragment"},
]

BATCH_14_MAPPING = {}

def render_photorealistic_batch_14():
    ...
    for item in BATCH_14_ITEMS:
        ...
        BATCH_14_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 14 photorealistic images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_14_MAPPING.items():
    ...
    print("\nBatch 14 Complete Summary:")
    for slug, url in results.items():
        print(f"  {slug}: {url}")

def main():
    render_photorealistic_batch_14()
    upload_and_sync_all()
