...
BATCH_20_ITEMS = [
    {"slug": "cjc-1295-dac-ipamorelin-20mg", "name": "CJC / Ipamorelin", "dose": "20mg High Dose", "type": "Secretagogue Stack"},
    {"slug": "hgh-191aa-200iu", "name": "Somatropin HGH", "dose": "200IU Ultra Pack", "type": "Growth Hormone"},
    {"slug": "mgf-10mg", "name": "MGF Growth Factor", "dose": "10mg High Dose", "type": "Splice Variant"},
    {"slug": "peg-mgf-20mg", "name": "PEG-MGF High Dose", "dose": "20mg High Dose", "type": "Pegylated Analog"},
    {"slug": "n-acetyl-semx-amidate-20mg", "name": "NA-Semax Amidate", "dose": "20mg High Dose", "type": "Nootropic Peptide"},
    {"slug": "n-acetyl-selank-amidate-20mg", "name": "NA-Selank Amidate", "dose": "20mg High Dose", "type": "Anxiolytic Peptide"},
    {"slug": "glow-blend-30mg", "name": "GLOW Ultra Blend", "dose": "30mg Ultra Blend", "type": "Peptide Tri-Blend"},
    {"slug": "recovery-stack-max", "name": "Recovery Stack Max", "dose": "30mg Pro Formula", "type": "Tissue Repair Stack"},
    {"slug": "skinny-shot-blend-ultra", "name": "Skinny Shot Ultra", "dose": "30mg Pro Formula", "type": "Metabolic Matrix"},
    {"slug": "super-shred-blend-pro", "name": "Super Shred Pro", "dose": "30mg Pro Formula", "type": "Fat Oxidation Stack"},
]

BATCH_20_MAPPING = {}

def render_photorealistic_batch_20():
    ...
    for item in BATCH_20_ITEMS:
        ...
        BATCH_20_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 20 photorealistic images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_20_MAPPING.items():
    ...
    print("\nBatch 20 Complete Summary:")
    for slug, url in results.items():
        print(f"  {slug}: {url}")

def main():
    render_photorealistic_batch_20()
    upload_and_sync_all()
