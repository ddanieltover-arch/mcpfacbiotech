...
BATCH_22_ITEMS = [
    {"slug": "humanin-50mg", "name": "Humanin Mitochondrial", "dose": "50mg Ultra Dose", "type": "Mitochondrial Peptide"},
    {"slug": "cagrilintide-20mg", "name": "Cagrilintide", "dose": "20mg Ultra Dose", "type": "Amylin Analog"},
    {"slug": "retatrutide-20mg", "name": "Retatrutide", "dose": "20mg Ultra Dose", "type": "Triple Agonist"},
    {"slug": "tirzepatide-30mg", "name": "Tirzepatide", "dose": "30mg Ultra Dose", "type": "Dual GIP/GLP-1"},
    {"slug": "tesamorelin-15mg", "name": "Tesamorelin", "dose": "15mg High Dose", "type": "GHRH Analog"},
    {"slug": "pt-141-20mg", "name": "PT-141 Bremelanotide", "dose": "20mg Ultra Dose", "type": "Melanocortin Agonist"},
    {"slug": "dsip-20mg", "name": "DSIP Delta Sleep", "dose": "20mg Ultra Dose", "type": "Sleep Architecture"},
    {"slug": "hgh-fragment-176-191-15mg", "name": "HGH Frag 176-191", "dose": "15mg High Dose", "type": "Lipolytic Peptide"},
    {"slug": "kisspeptin-10-15mg", "name": "Kisspeptin-10", "dose": "15mg High Dose", "type": "Hypothalamic Peptide"},
    {"slug": "kpv-15mg", "name": "KPV Anti-Inflammatory", "dose": "15mg High Dose", "type": "Tripeptide Derivative"},
]

BATCH_22_MAPPING = {}

def render_photorealistic_batch_22():
    ...
    for item in BATCH_22_ITEMS:
        ...
        BATCH_22_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 22 photorealistic images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_22_MAPPING.items():
    ...
    print("\nBatch 22 Complete Summary:")
    for slug, url in results.items():
        print(f"  {slug}: {url}")

def main():
    render_photorealistic_batch_22()
    upload_and_sync_all()
