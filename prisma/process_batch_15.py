...
BATCH_15_ITEMS = [
    {"slug": "semax-30mg", "name": "Semax", "dose": "30mg High Potency", "type": "Nootropic Heptapeptide"},
    {"slug": "selank-30mg", "name": "Selank", "dose": "30mg High Potency", "type": "Anxiolytic Regulatory"},
    {"slug": "ll-37-10mg", "name": "LL-37", "dose": "10mg Bulk Vial", "type": "Antimicrobial Peptide"},
    {"slug": "humanin-20mg", "name": "Humanin", "dose": "20mg High Dose", "type": "Cytoprotective Peptide"},
    {"slug": "oxytocin-10mg", "name": "Oxytocin", "dose": "10mg", "type": "Neuropeptide Hormone"},
    {"slug": "pinealon-20mg", "name": "Pinealon", "dose": "20mg High Dose", "type": "Pineal Bioregulator"},
    {"slug": "vesugen-20mg", "name": "Vesugen", "dose": "20mg High Dose", "type": "Vascular Bioregulator"},
    {"slug": "thymosin-a1-5mg", "name": "Thymosin-α1", "dose": "5mg", "type": "Immune Modulator"},
    {"slug": "epithalon-20mg", "name": "Epithalon", "dose": "20mg", "type": "Tetrapeptide Activator"},
    {"slug": "bpc-157-tb-500-20mg", "name": "BPC-157 + TB-500", "dose": "20mg High Dose Blend", "type": "Synergistic Healing"},
]

BATCH_15_MAPPING = {}

def render_photorealistic_batch_15():
    ...
    for item in BATCH_15_ITEMS:
        ...
        BATCH_15_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 15 photorealistic images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_15_MAPPING.items():
    ...
    print("\nBatch 15 Complete Summary:")
    for slug, url in results.items():
        print(f"  {slug}: {url}")

def main():
    render_photorealistic_batch_15()
    upload_and_sync_all()
