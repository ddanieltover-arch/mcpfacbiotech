...
BATCH_5_ITEMS = [
    {"slug": "cagrilintide", "name": "Cagrilintide", "dose": "5mg", "type": "Lyophilized Powder"},
    {"slug": "tirzepatide", "name": "Tirzepatide", "dose": "10mg", "type": "Lyophilized Powder"},
    {"slug": "tesamorelin", "name": "Tesamorelin", "dose": "10mg", "type": "Lyophilized Powder"},
    {"slug": "pt-141", "name": "PT-141 (Bremelanotide)", "dose": "10mg", "type": "Lyophilized Powder"},
    {"slug": "dsip", "name": "DSIP", "dose": "5mg", "type": "Lyophilized Powder"},
    {"slug": "igf-1-lr3", "name": "IGF-1 LR3", "dose": "1mg", "type": "Lyophilized Powder"},
    {"slug": "hgh-fragment-176-191", "name": "HGH Frag 176-191", "dose": "5mg", "type": "Lyophilized Powder"},
    {"slug": "bpc-157-tb-500-blend", "name": "BPC-157 + TB-500", "dose": "5mg / 5mg Blend", "type": "Lyophilized Powder"},
    {"slug": "kisspeptin-10", "name": "Kisspeptin-10", "dose": "10mg", "type": "Lyophilized Powder"},
    {"slug": "kpv", "name": "KPV", "dose": "10mg", "type": "Lyophilized Powder"},
]
...
def render_batch_5():
    ...
    try:
        font_title_lg = ImageFont.truetype("arialbd.ttf", 32)
        font_title_sm = ImageFont.truetype("arialbd.ttf", 25)
    ...
    for item in BATCH_5_ITEMS:
        ...
        BATCH_5_MAPPING[item["slug"]] = brain_filename

def upload_and_sync_all():
    print("\nUploading all 10 Batch 5 images to Supabase Storage & local web directory...")
    headers = {
    ...
    results = {}
    for slug, brain_filename in BATCH_5_MAPPING.items():
